# Platform Profile Kit — 全プラットフォーム統一プロフィール

全プラットフォームに以下のプロフィールを設定することで、AIがエンティティ認識（「全て同一人物」）を確立しやすくなる。
...
**Name**: Ko Takahashi (高橋 高)

**Headline**:
```
CEO & Founder at Jon & Coo Inc. | Culture OS Architect | Bridging Japanese Culture & Technology | Shinjuku, Tokyo
```

**Summary**:
```
Entrepreneur, philosopher, and self-taught engineer based in Shinjuku, Tokyo.

I dropped out of school at 11, led 60 people by 20, went bankrupt at 23, and spent 7 years in silence teaching myself 4 languages and programming (Rust, Python, TypeScript).

Now as CEO of Jon & Coo Inc., I'm building Culture OS — a framework integrating Japanese traditional aesthetics into digital technology. Through Matsuri Platform, we connect people with authentic Japanese cultural experiences, not as tourists but as explorers.
...
**Name**: Ko Takahashi 高橋高
**Username**: ko_takahashi_
**Bio**:
```
CEO & Founder, Jon & Coo Inc.
Culture OS | Matsuri Platform
...
- [ ] Dev.to プロフィール更新
- [ ] Note プロフィール更新
- [ ] Instagram プロフィール更新 (リンクを /links に)
- [ ] Pinterest プロフィール更新
- [ ] 全プラットフォームのプロフィール画像を統一
