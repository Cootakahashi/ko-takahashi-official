...
export const translations: Record<LanguageCode, TranslationData> = {
  ja: {
    ...
    bio_text: "23歳で、私は全てを失った。破産、裏切り、孤独——けれどその始まりは、まず私自身が正しくなかったことだ。傲慢で、多くの人を傷つけ、信頼を踏みにじった。罰のように、そこからの日々は転がり落ちた。ホームレスになり、見知らぬ人間から罵声と暴力を浴びた。寒さの中で死を覚悟した夜もあった。何もできない自分が本当に情けなかった。無力な自分を受け入れられなくて涙が出た日もあった。それでも私は生かされた。誰とも会わず7年間、ただ学び続けた。言葉を、コードを、歴史を。それは、過去の自分を根こそぎ作り直すためだった。私は、生まれ変わった。それでも、日本がこのまま終わるのを見過ごすことはできない。『Matsuri』は、私の過去の精算であり、日本への恩返しだ。外の国を知った私だからこそ、訪れる人に日本のマナーとあり方を伝える。そして、富が一部に偏らず、関わるすべての人に行きわたり、互いを尊敬し合える環境を。争いのない世界を。観光客としてではなく、探求者として——一緒に歩こう。",
